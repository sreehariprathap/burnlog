// components/LifeLogProfileMenu.tsx
'use client';
...
type LifeLogProfileMenuProps = {
  isActive: boolean;
};

export function LifeLogProfileMenu({ isActive }: LifeLogProfileMenuProps) {
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          {isActive && (
            <motion.span
              layoutId="lifelog-bottom-nav-active"
