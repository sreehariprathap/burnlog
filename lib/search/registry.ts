...
export const SEARCH_REGISTRY: SearchItem[] = [
  ...
  { app: 'moneylog', label: 'Plan', description: 'Budget planning (MoneyLog)', href: '/moneylog/plan', icon: ClipboardList },
  { app: 'moneylog', label: 'Goals', description: 'Financial goals — savings, debt payoff (MoneyLog)', href: '/moneylog/goals', icon: Target },
  { app: 'moneylog', label: 'Insights', description: 'Spending trends and recurring items (MoneyLog)', href: '/moneylog/insights', icon: TrendingUp },
  ...
  { app: 'tasklog', label: 'Plan', description: 'Plan and break down ideas (TaskLog)', href: '/tasklog/plan', icon: Lightbulb },
  { app: 'tasklog', label: 'Goals', description: 'Track your goals, separate from tasks (TaskLog)', href: '/tasklog/goals', icon: ListChecks },
  ...
  { app: 'sociallog', label: 'Search', description: 'Search posts, users, and topics (SocialLog)', href: '/sociallog/search', icon: Search },
  ...
  { app: 'shoppinglog', label: 'Sell', description: 'Create and manage your own listings', href: '/shoppinglog/sell', icon: Store },
