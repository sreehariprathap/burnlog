...
/** The "home" tab of /logbook — see page.tsx for the tab switcher this is
 * mounted from. Identical to the old standalone page.tsx, minus TopBar's
 * sibling LogbookBottomNav (now rendered once by the shared page shell). */
export function LogbookHomeContent() {
